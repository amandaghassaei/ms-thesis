...
Additionally, only parts that have been joined together to form one constrained cell add rigidity to the structure, and in simulation we are only concerned with the behavior of the rigid elements.\\
