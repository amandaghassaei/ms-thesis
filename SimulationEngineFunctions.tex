...
\[ \phi_y = \dfrac{12EI_z}{GA_{sy}l^2} \qquad  and \qquad \phi_z = \dfrac{12EI_y}{GA_{sz}l^2} \]

Removing the shear and torsional terms from elements of Equation \ref{} gives the Euler-Bernoulli beam theory (only valid for small angle approx)\\
