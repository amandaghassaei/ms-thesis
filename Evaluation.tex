...
As I described in Section \ref{sec:bendingdominance}, a bending dominated beam model is more appropriate for long beams.   Given the aspect ratio of the voxels being modeled in VoxCAD (very similar to what I've been modeling), the absence of shearing causes deflections to be underestimated \cite{Bower2009}.  Additionally, VoxCAD relies on the same small angle approximations present in the Timoshenko model.\\
