...
\chapter{Design Hierarchy}\label{chapter:HierarchicalDesign}
...
\begin{sidewaysfigure}
 \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{FullHierarchy.png}
  \caption{Diagram of hierarchical breakdown of robotic modules into functional parts, functional primitives, and finally bulk material elements.  A more detailed view of the relationship between parts at the element and functional primitive levels is given in Figure \ref{fig:Hierarchy-ElementsParts}, and again, for the functional primitive and functional parts levels in Figure \ref{fig:Hierarchy-FunctionPrimitivesParts}.  \textit{Image Credit (for photos of fabricated parts): Will Langford 2016} }
  \label{fig:FullHierarchy}
\end{sidewaysfigure}

\begin{figure}
  \includegraphics[width=\linewidth]{Hierarchy-ElementsParts.png}
  \caption{Detail view of translation between bulk material elements and functional primitives.}
  \label{fig:Hierarchy-ElementsParts}
\end{figure}

\begin{figure}
  \includegraphics[width=\linewidth]{Hierarchy-FunctionPrimitivesParts.png}
  \caption{Detail view of translation between bulk functional primitives and functional parts.}
...
For example, an aluminum element type would have the properties of being conductive, stiff, and lightweight and a rubber element type would be insulating and flexible.  Current elements types are described in Figure \ref{fig:Hierarchy-ElementsParts}.  Other element types may include magnetic and magnetically permeable types, additional actuation types, and thermally conductive and insulating types.\\
...
Hydrogen bonding and other non-covalent interactions between amino acid side-chains, along with external effects, determine the three dimensional structure of a protein.
...
A major design consideration in our proposed assembly system is the number of function building blocks to include in the feedstock.\\
