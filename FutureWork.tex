...
\begin{figure}
  ...
  \caption{Schematic view of translation of an assembly of elements into parameters of a functional primitive: 15 stiffness constants, mass, and moment of inertia tensor.  Blue boxes indicate "attachment points" for applied boundary conditions in multidimensional stiffness measurements.}
...
The ultimate goal of the software tools developed in this thesis is to close the loop between design and simulation through declarative design.  constrained optimization\\
